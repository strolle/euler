...
public class PyramidSum {
	...
	static int[][] readInput() throws Exception{
		BufferedReader buf = new BufferedReader(new InputStreamReader(new FileInputStream("C:/programming/workspace/euler/src/se/strolle/euler/problems/p067/triangle.txt")));
